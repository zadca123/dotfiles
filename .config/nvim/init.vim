...
let mapleader = "," " idk how it works, map space
set number
...
set hidden
set undofile " undo changes even after closing the editor
...
" :CocInstall coc-explorer coc-pyright coc-json coc-css coc-html coc-tsserver
" coc-texlab coc-sh coc-markdownlint
nnoremap <Space>. :CocCommand explorer
            \ --toggle
            \ --sources=buffer+,file+
            \ --root-strategies sourceBuffer
            \<CR>
